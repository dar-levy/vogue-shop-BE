...
async function createNewUser(username, email, name, password) {
    ...
    let new_user = {username: username, email: email, name: name, password: hashed_pass, salt: salt, isAdmin: false};
